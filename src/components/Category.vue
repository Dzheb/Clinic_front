  ...
  <div class="main">
    ...
    >
      <form class="update_form_content_category">
        ...
        <div>
          Категория врача:
          <input type="text" required v-model="category.category" />
        </div>
...
export default {
  ...
  methods: {
    deleteCategory(id) {
      //
      fetch(this.url+'category/' + id, {
        method: 'DELETE',
      })
        .then((response) => response.ok)
        .then((data) => {
          if (data)
            fetch(this.url+'category')
    ...
    updateCategory(id) {
      ...
      const updateForm_category = document.querySelector(
    ...
    sendCategory() {
      ...
      if (this.add) {
        ...
        fetch(this.url+'category', requestOptions)
          .then((response) => response.json())
          .then((data) => {
        ...
        fetch(this.url+'category/' + updateId, requestOptions)
          .then((response) => response.json())
          .then((data) => {
            alert('Информация о категории # ' + data + ' отправлена');
          });
